  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        ...
        return (
          ...
          >
            {a.signed_url ? (
              ...
              <div className="flex h-full w-full items-center justify-center bg-gray-50 text-xs text-gray-400">sin preview</div>
            )}
            {selected && (
      ...
      {placeholders.map((_, i) => (
        <div
          key={`ph-${i}`}
          className="flex aspect-square items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50"
        >
