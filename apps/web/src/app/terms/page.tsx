  ...
  return (
    <LegalShell>
      ...
      <section className="mt-8 space-y-6 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-foreground">3. Tu cuenta</h2>
        ...
        <h2 className="text-xl font-semibold text-foreground">5. Cuentas conectadas</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground">6. IA y contenido generado</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground">7. Disponibilidad y suspensión</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground">9. Datos personales</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground">10. Cambios a los términos</h2>
        <p>
          Si actualizamos estos términos, te notificaremos por correo. El uso
          continuado tras la notificación implica aceptación.
        </p>

        <h2 className="text-xl font-semibold text-foreground">11. Jurisdicción</h2>
        <p>
        ...
        <p>
          <a href="mailto:legal@kapisg.com" className="text-primary underline">
            legal@kapisg.com
          </a>
        </p>
      </section>
